        ...
        <div class="modal-dialog modal-dialog-scrollable modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Blog Operations</h5>
    ...
    <div class="container mt-5">
        <div class="row bg-white mx-1">
            <div class="col-6 d-flex justify-content-start align-items-center">
                <p class="m-0 py-3 fw-bold fs-5">All Blogs</p>
            </div>
            <div class="col-6 d-flex justify-content-end align-items-center">
                <form action="" class="position-relative">
                    <input type="text" placeholder="Seach Blogs" name="s" class="form-control" style="width:400px;border:1px solid #0003">
                    <input type="submit" value="Search Blogs" class="btn btn-dark position-absolute" style="top:0px;right:0px">
                </form>
            </div>
        </div><br>
        <div class="row bg-white mx-1">
                ...
                <table class="table table-striped" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> {{ $blog->bcname }}</td>
                            <td class="">
                                <a href="#" class="btn btn-dark text-white seotag mb-1" value="{{ $blog->id }}"
                                    data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                        class="fa-brands fa-searchengin"></i>
                                    SEO</a>
                                <a id="views" target="_blank" href="/blog/{{ $blog->slug }}" class="btn btn-success text-white reads views1 mb-1"
                                    ><i
                                        class="fa-solid fa-eye"></i> View</a>
                                <a href="#" class="btn btn-warning text-white edit mb-1" value="{{ $blog->id }}"
                                    data-bs-toggle="modal" data-bs-target="#exampleModal"><i
                                        class="fa-solid fa-pen-to-square"></i></a>
                                <a href="#" class="btn btn-danger text-white delete mb-1" value="{{ $blog->id }}"><i
